...
pr1 = calculate_rgb_psnr(im1, im3)
pr2 = calculate_rgb_psnr(im2, im3)
ssim1 = calculate_ssim(im1,im3)
ssim2 = calculate_ssim(im2,im3)
print(f"PSNR:ours={pr1},others={pr2}\n")
print(f"SSIM:ours={ssim1},others={ssim2}\n")
